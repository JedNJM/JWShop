...
class HomeController extends Controller
{
    ...
    public function productReviewUpdate(Request $request, $id)
    {
        ...
        if($review){
            ...
            if($status){
                request()->session()->flash('success','Review mis à jour avec succès');
            }
            else{
                request()->session()->flash('error','Veuillez réessayer!');
            }
            ...
            request()->session()->flash('error','Review introuvable !');
        }
    ...
    public function productReviewDelete($id)
    {
        ...
        if($status){
            request()->session()->flash('success','Review supprimé avec succès');
        }
        else{
            request()->session()->flash('error','Veuillez réessayer');
        }
