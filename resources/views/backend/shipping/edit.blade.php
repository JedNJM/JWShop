...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('shipping.update',$shipping->id)}}">
        ...
        <input id="inputTitle" type="text" name="type" placeholder="Entrer type"  value="{{$shipping->type}}" class="form-control">
        @error('title')
        ...
        <input id="price" type="number" name="price" placeholder="Entrer prix"  value="{{$shipping->price}}" class="form-control">
        @error('price')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>
