...
<div class="card">
    <h5 class="card-header">Modifier Tag Publication </h5>
    <div class="card-body">
      <form method="post" action="{{route('post-tag.update',$postTag->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Entrer titre"  value="{{$postTag->title}}" class="form-control">
          @error('title')
