...
<div class="card">
    <h5 class="card-header">Modifier Catégorie de Publication </h5>
    <div class="card-body">
      <form method="post" action="{{route('post-category.update',$postCategory->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Entrer titre"  value="{{$postCategory->title}}" class="form-control">
          @error('title')
