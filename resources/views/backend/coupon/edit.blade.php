...
<div class="card">
    <h5 class="card-header">Editer Coupon</h5>
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="code" placeholder="Entrer le code promotionnel"  value="{{$coupon->code}}" class="form-control">
          @error('code')
          ...
          <div class="form-group">
              ...
              <select name="type" class="form-control">
                  ...
                  <option value="percent" {{(($coupon->type=='percent') ? 'selected' : '')}}>Pourcent</option>
              </select>
              @error('type')
              <span class="text-danger">{{$message}}</span>
              @enderror
