    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Entrer titre"  value="{{$post->title}}" class="form-control">
          @error('title')
        ...
        @php
              ...
              @endphp
        <div class="form-group">
          <label for="tags">Étiqueter</label>
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--Choisir Étiqueter--</option>
        ...
        <div class="form-group">
          <label for="added_by">Auteur(e)</label>
          <select name="added_by" class="form-control">
              <option value="">--Choisir Auteur(e)--</option>
...
<script>
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "Ecrire une courte citation...",
          tabsize: 2,
          height: 100
      });
    });
