                ...
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="right-content">
                        ...
                        <li><i class="ti-location-pin"></i> <a href="{{route('order.track')}}">Suivi de commande</a></li>
                            ...
                            @else
                                <li><i class="ti-power-off"></i><a href="{{route('login.form')}}">Connection /</a> <a href="{{route('register.form')}}">S'inscrire</a></li>
                            @endauth
                        </ul>
                    </div>
                    <!-- End Top Right -->
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp
                        <a href="{{route('home')}}"><img src="@foreach($settings as $data) {{$data->logo}} @endforeach" height="250" alt="logo"></a>
                            ...
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
                                        ...
                                        <a href="{{route('wishlist')}}">Voir la liste de Favoris</a>
                                    </div>
