...
<div class="product-area section">
        <div class="container">
            ...
            <a data-toggle="modal" data-target="#{{$product->id}}" title="Quick View" href="#"><i class=" ti-eye"></i></i><span>Achat Rapide</span></a>
             <a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" ><i class=" ti-heart "></i><span>Ajouter aux Favoris</span></a>
                                                </div>
                        ...
                        <div class="single-product">
                            <div class="product-img">
                                ...
                                <div class="button-head">
                                    ...
                                    <div class="product-action-2">
                                        <a href="{{route('add-to-cart',$product->slug)}}">Ajouter aux Panier</a>
                                    </div>
                                </div>
                            </div>
                            <div class="product-content">
                            ...
                            <div class="single-list">
                                ...
                                <div class="col-lg-6 col-md-6 col-12 no-padding">
                                    <div class="content">
                                        ...
                                        <p class="price with-discount">{{number_format($product->discount,2)}}TND</p>
                                    </div>
                                </div>
                                </div>
                            </div>
