...
@endsection
@section('title','SHOP || DETAILLE PRODUIT')
@section('main-content')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="product-buy">
												...
												<p class="cat mt-1">Sub Catégorie :<a href="{{route('product-sub-cat',[$product_detail->cat_info['slug'],$product_detail->sub_cat_info['slug']])}}">{{$product_detail->sub_cat_info['title']}}</a></p>
												@endif
	...
	<h4>Vos Etoiles <span class="text-danger">*</span></h4>
