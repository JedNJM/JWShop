                ...
                <div class="p-5">
                  ...
                  <form class="user"  method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Entrer l'adresse e-mail..."  required autocomplete="email" autofocus>
                        @error('email')
